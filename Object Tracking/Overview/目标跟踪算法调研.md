...
* 交叉熵损失函数 (Cross Entropy Loss Function)
  ...
  * 公式
    ...
    * $$
      ...
      -\sum\limits_x
      \left(
      p\left(x\right)\mathop{log}q\left(x\right)+
      \left(1-p\left(x\right)\right)\mathop{log}\left(1-q\left(x\right)\right)
      \right)
      $$
...
* 平滑 L1 损失函数 (Smooth L1 Loss Function)
  ...
  * 公式
    ...
    * L1
      ...
      * $$
        \mathop{L1}\left(x\right)=|x|
        $$

    * L2

      * $$
        \mathop{L2}\left(x\right)=x^2
        $$

    * Smooth L1

      * $$
        \mathop{SmoothL1}\left(x\right)=
        \begin{dcases}
        \lambda x^2,&if|x|<\beta\\
        |x|-\gamma,&otherwise
        \end{dcases}
        $$
